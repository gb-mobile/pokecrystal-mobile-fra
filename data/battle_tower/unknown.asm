...
; 70 tables (BATTLETOWER_NUM_UNIQUE_TRAINERS) of 3 12 byte easy chat messages.
; Easy chat isn't used in the non-japanese release versions, yet they added this.
	table_width EASY_CHAT_MESSAGE_LENGTH * 3, BattleTowerTrainerData
