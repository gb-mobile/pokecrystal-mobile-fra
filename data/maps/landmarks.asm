...
SilverCaveName:      db "GROTTE¯ARGENTEE@"
SproutTowerName:     db "TOUR¯CHETIFLOR@"
...
CeruleanCaveName:    db "CAVERNE¯AZUREE@" ; unreferenced
...
BurnedTowerName:     db "TOUR¯CENDREE@"
FastShipName:        db "BATEAU¯EXPRESS@"
ViridianForestName:  db "FORET¯DE JADE@" ; unreferenced
