...
DEF BATTLE_TOWER_STRUCT_LENGTH EQU NAME_LENGTH - 1 + 1 + BATTLETOWER_PARTY_LENGTH * NICKNAMED_MON_STRUCT_LENGTH + EASY_CHAT_MESSAGE_LENGTH * 3 ; $e0
DEF BATTLE_TOWER_DATA_UPLOAD_LENGTH EQU 2 + MOBILE_EMAIL_LENGTH + 4 + PLAYER_NAME_LENGTH - 1 + 1 + BATTLETOWER_PARTY_LENGTH * NICKNAMED_MON_STRUCT_LENGTH + EASY_CHAT_MESSAGE_LENGTH * 3 + 6

DEF HONOR_ROLL_ENTRIES EQU 30
DEF HONOR_ROLL_DATA_LENGTH EQU (PLAYER_NAME_LENGTH - 1) * HONOR_ROLL_ENTRIES
